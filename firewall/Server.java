...
import static com.mycompany.firewall.ClientSession.info;
import java.io.*;
import java.net.*;
import java.util.*;
/**
...
public class Server {
        ...
        Server()
        {
            ...
            ServerSide.getWelcomeMessage(info);
        ...
        public void run() {
            ...
            try{
                ...
                if(list.contains(clientsocket.getRemoteSocketAddress().toString().substring(1, clientsocket.getRemoteSocketAddress().toString().indexOf(":"))))
                {
                    ...
                    ServerSide.getConfirmation(info);
                ...
                while(true)
                {
                    ...
                    for(j=0;j<l;j++)
                    {
                        ...
                        {
                            info[0]=packet[j];
                            ServerSide.getClientMessage(info);
